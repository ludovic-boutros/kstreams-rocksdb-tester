 ...
 * @see TestOutputTopic
 */
public class ExtendedTopologyTestDriver implements Closeable {

    private static final Logger log = LoggerFactory.getLogger(ExtendedTopologyTestDriver.class);

    private final LogContext logContext;
    private Time mockWallClockTime;
     ...
     */
    public ExtendedTopologyTestDriver(final Topology topology) {
     ...
     * @param initialWallClockTimeMs the initial value of internally mocked wall-clock time
     */
    private ExtendedTopologyTestDriver(final InternalTopologyBuilder builder,
                                       final Properties config,
        ...
        streamsMetrics = setupMetrics(streamsConfig);
     ...
     */
    public final <K, V> ExtendedTestInputTopic<K, V> createInputTopic(final String topicName,
                                                                      final Serializer<K> keySerializer,
                                                                      final Serializer<V> valueSerializer) {
        return new ExtendedTestInputTopic<>(this, topicName, keySerializer, valueSerializer, Instant.now(), Duration.ZERO);
    }
    ...
    public final <K, V> ExtendedTestInputTopic<K, V> createInputTopic(final String topicName,
        ...
        return new ExtendedTestInputTopic<>(this, topicName, keySerializer, valueSerializer, startTimestamp, autoAdvance);
    }
     ...
     */
    public final <K, V> ExtendedTestOutputTopic<K, V> createOutputTopic(final String topicName,
                                                                        final Deserializer<K> keyDeserializer,
                                                                        final Deserializer<V> valueDeserializer) {
        return new ExtendedTestOutputTopic<>(this, topicName, keyDeserializer, valueDeserializer);
    }
    ...
    public void setMockWallClockTime(Time mockWallClockTime) {
        this.mockWallClockTime = mockWallClockTime;
    }

    public StreamsMetricsImpl getStreamsMetrics() {
        return streamsMetrics;
    }
}
