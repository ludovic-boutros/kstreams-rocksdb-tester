 ...
 */
public class ConfigurableIteratorRocksDBStore implements KeyValueStore<Bytes, byte[]>, BatchWritingStore {
    ...
    class SingleColumnFamilyAccessor implements RocksDBAccessor {
        ...
        public KeyValueIterator<Bytes, byte[]> range(final Bytes from,
            ...
            return new RocksDBRangeIterator(
                    name,
                    readOptions != null ? db.newIterator(columnFamily, readOptions) : db.newIterator(columnFamily),
                    openIterators,
                    from,
                    to,
                    forward,
