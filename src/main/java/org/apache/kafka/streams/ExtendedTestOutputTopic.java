 ...
 */
public class ExtendedTestOutputTopic<K, V> {
    private final ExtendedTopologyTestDriver driver;
    private final String topic;
    private final Deserializer<K> keyDeserializer;
    private final Deserializer<V> valueDeserializer;

    ExtendedTestOutputTopic(final ExtendedTopologyTestDriver driver,
